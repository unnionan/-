...
<html>
  ...
  <body style = "background:url(image/UserUpdatePwd.jpg);background-size:100% 100%;background-attachment:fixed">
    <form action = "GetUserUpdatePwd.do" accept = "get">
      <table align = "center" valign = "middle" width = "25%" height = "50%" border = "0" cellpadding = "2">
           <tr height = "50" valign = "middle">
                <th width = "66%" colspan = "1">用户密码修改</th>	
           </tr>
